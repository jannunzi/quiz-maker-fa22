    ...
    return(
        <div>
            ...
            <div id="question123">
                ...
                <br/>
                <br/>
                Which of the following options updates a document whose
                field <b>{field1}</b> is equal to <b>"{valueStr}"</b> and modifies only
                field <b>{field2}</b> to a new value of <b>{valueNum}</b>?
